...
_FINGER_MIMICS = [
  ...
  ("L_thumb_int_mimic",  "L_thumb_intermediate_joint",   "L_thumb_proximal_pitch_joint",    1.6),
  ...
  ("R_thumb_int_mimic",  "R_thumb_intermediate_joint",   "R_thumb_proximal_pitch_joint",    1.6),
...
ACTUATOR_4010    = ElectricActuator(reflected_inertia=ARMATURE_4010,    velocity_limit=22.0, effort_limit=5.0)
