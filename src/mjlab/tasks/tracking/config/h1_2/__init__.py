...
from .env_cfgs import unitree_h1_2_flat_tracking_env_cfg
from .rl_cfg import unitree_h1_2_tracking_ppo_runner_cfg

register_mjlab_task(
  task_id="Mjlab-Tracking-Flat-H1_2",
...
register_mjlab_task(
  task_id="Mjlab-Tracking-Flat-H1_2-No-State-Estimation",
  env_cfg=unitree_h1_2_flat_tracking_env_cfg(has_state_estimation=False),
  play_env_cfg=unitree_h1_2_flat_tracking_env_cfg(
