"""
h1_2_hands_inspect.py
=====================
Carga la mano Inspire derecha (standalone) y permite mover cada dedo
con sliders interactivos. También muestra los sistemas de referencia
principales de cada body.

La mano Inspire es la misma que se usa en el H1 v2 con manos.

Uso:
  python h1_2_hands_inspect.py
"""
...
# ── Ruta al XML de la mano Inspire (misma que G1) ────────────────────────────
...
if __name__ == "__main__":
  print(f"Cargando modelo Inspire Hand:\n  {HAND_XML}\n")
