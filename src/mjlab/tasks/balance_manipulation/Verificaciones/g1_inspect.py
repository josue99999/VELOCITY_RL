...
G1_XML    = os.path.join(BASE_DIR, "..", "..", "asset_zoo", "robots",
                         "robot_hands", "xmls", "g1.xml")
...
def print_wrist_frames(model, data):
    ...
    for site_name in WRIST_SITES:
        ...
        print(f"    Eje X (+rojo  ): [{rot[0,0]:6.3f}  {rot[1,0]:6.3f}  {rot[2,0]:6.3f}]")
        print(f"    Eje Y (+verde ): [{rot[0,1]:6.3f}  {rot[1,1]:6.3f}  {rot[2,1]:6.3f}]")
        print(f"    Eje Z (+azul  ): [{rot[0,2]:6.3f}  {rot[1,2]:6.3f}  {rot[2,2]:6.3f}]")
