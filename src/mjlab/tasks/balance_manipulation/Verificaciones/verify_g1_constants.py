...
Verifica que el g1_constants (con manos) compila correctamente y que:
...
# Altura del pelvis — debería ser ~0.76
pelvis_z = data.qpos[2]
ok_height = 0.5 < pelvis_z < 1.2
print(f"  {check_mark(ok_height)}  Altura pelvis = {pelvis_z:.4f} m  (esperado ~0.76)")
