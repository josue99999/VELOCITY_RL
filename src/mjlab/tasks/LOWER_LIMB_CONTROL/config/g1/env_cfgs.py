"""Unitree G1 lower limb velocity environment configurations."""
...
def unitree_g1_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  # Filter G1_ACTION_SCALE to only include controlled joints.
  ...
  # Rationale for std values (lower limb + waist for stability):
  # - Knees/hip_pitch get the loosest std to allow natural leg bending during stride.
  # - Hip roll/yaw stay tighter to prevent excessive lateral sway and keep gait stable.
  # - Ankle roll is very tight for balance; ankle pitch looser for foot clearance.
  # - Waist roll/pitch/yaw stay tight to keep the torso upright and stable.
