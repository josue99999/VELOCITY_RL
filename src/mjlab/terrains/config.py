...
# Coarser heightfield resolution for robots with many foot geoms (e.g. H1_2 with 14
# capsules). MuJoCo limits hfield-geom contacts to 50 per pair; finer grids cause
# overflow. horizontal_scale=0.2 → 40x40 cells vs 0.1 → 80x80.
H1_2_HFIELD_HORIZONTAL_SCALE = 0.2
...
ROUGH_TERRAINS_H1_2_CFG = TerrainGeneratorCfg(
  size=(8.0, 8.0),
  border_width=20.0,
  num_rows=10,
  num_cols=20,
  sub_terrains={
    ...
    "hf_pyramid_slope": terrain_gen.HfPyramidSlopedTerrainCfg(
      ...
      platform_width=2.0,
      border_width=0.25,
      horizontal_scale=H1_2_HFIELD_HORIZONTAL_SCALE,
    ),
    "hf_pyramid_slope_inv": terrain_gen.HfPyramidSlopedTerrainCfg(
      proportion=0.1,
      slope_range=(0.0, 1.0),
