...
from mjlab.tasks.tracking.config.h1_2.env_cfgs import (
  unitree_h1_2_flat_tracking_env_cfg,
)
...
def main(
  ...
  Args:
    ...
    output_name: Name for the W&B artifact (e.g. "huayno-g1").
    robot: Robot model to use ("g1" or "h1_2").
  ...
  if robot == "g1":
    ...
    scene_cfg = unitree_h1_2_flat_tracking_env_cfg().scene
    joint_names = _H1_2_JOINT_NAMES
